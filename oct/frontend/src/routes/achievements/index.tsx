...
export default function AchievementsInfoPage() {
  return (
    <div className="info-container">
      ...
      <p className="info-text">
        Each achievement gains your team between 10 and 100 points.
        Achievements have a base of 100 points and decrease depending on 
        how many teams have completed the achievement at a given moment. 
        This means that your points can decrease as other teams complete achievements.
      </p>
    </div>
  );
}
